function fillElements() {
  ...
  for (var Genre = 0; Genre < GenreList.length; Genre++) {
    ...
    for (var Cluster = 0; Cluster < NewsData[0][GenreList[Genre]].length; Cluster++) {
      ...
      Image.src = NewsData[0][GenreList[Genre]][Cluster][0].ImgLink;
      ...
      for(var NewsItem = 0; NewsItem < NewsData[0][GenreList[Genre]][Cluster].length; NewsItem++){
        ...
        HeadLine.href = NewsData[0][GenreList[Genre]][Cluster][NewsItem].HLink;
        HeadLine.innerHTML = NewsData[0][GenreList[Genre]][Cluster][NewsItem].HL;

        var Source = document.createElement("a");
        SrcItem.appendChild(Source)
        Source.className = "Source";
        Source.href = NewsData[0][GenreList[Genre]][Cluster][NewsItem].SrcLink;
        Source.innerHTML = NewsData[0][GenreList[Genre]][Cluster][NewsItem].Src;
      }
    }
  }
}